...
const ContactSection = () => {
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    // Changed create -> createMessage & added phone field directly
  ...
  return (
    <section
      className="py-[60px] md:py-[80px] px-4 md:px-[40px] relative overflow-hidden"
      id="contact-section"
    ...
    >
      ...
      <img
        src="/images/half.png"
        className="absolute left-0 top-0 h-full opacity-60 z-0 pointer-events-none object-contain object-left"
        alt=""
      />
      ...
      <div className="max-w-[1140px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 relative z-10 items-start">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[#C5A253] text-[0.72rem] font-bold tracking-[3px] uppercase">
              CONTACT US
            </span>
          ...
          <h2 className="font-serif text-[2.1rem] md:text-[2.4rem] font-bold text-[#1a3a2a] mb-4 leading-[1.2]">
            Let’s Preserve Sri Lanka’s
            <br />
            Heritage Together
          </h2>

          <p className="text-gray-600 text-[0.88rem] leading-[1.65] mb-8 max-w-[95%]">
            Have questions, research inquiries, partnership opportunities, or
            wish to contribute to documenting Sri Lanka’s historical treasures?
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mb-10">
            {/* Address */}
            <div className="bg-white/90 backdrop-blur-sm rounded-[14px] p-4 flex items-center gap-3.5 shadow-[0_6px_24px_rgba(31,94,78,0.18)] border border-gray-100">
              ...
              <div>
                <h5 className="text-[#1F5E4E] text-[0.85rem] font-bold">
                  Address
                </h5>
                <p className="text-gray-500 text-[0.72rem] leading-[1.3] mt-0.5">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-[14px] p-4 flex items-center gap-3.5 shadow-[0_6px_24px_rgba(31,94,78,0.18)] border border-gray-100">
              ...
              <div className="min-w-0">
                ...
                <p className="text-gray-500 text-[0.72rem] leading-[1.3] truncate mt-0.5">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <h3 className="font-serif text-[1.5rem] font-bold text-[#1a3a2a]">
                Our Partners
              </h3>
              <div className="h-[1px] w-12 bg-[#C5A253]/40"></div>
            </div>
            ...
            <div className="flex items-center gap-8 flex-wrap">
              <img
                ...
                className="h-[80px] md:h-[90px] w-auto object-contain transition-transform hover:scale-105"
              ...
              <img
                ...
                className="h-[75px] md:h-[85px] w-auto object-contain transition-transform hover:scale-105"
                alt="HejCeylon"
              />
            </div>
          </div>
        ...
        <div className="bg-white rounded-[24px] p-6 md:p-10 shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100/80">
          ...
          <p className="text-[0.85rem] text-gray-500 mb-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label className="block text-[0.82rem] font-semibold text-[#1a3a2a] mb-1.5">
                Full Name
              </label>
              <input
                type="text"
