...
import type { FacilitiesTravelFormValue } from "../FacilitiesTravelForm";
...
export interface EditFacilitiesTravelFormProps {
  ...
  onChange: <K extends keyof FacilitiesTravelFormValue>(
    field: K,
    value: FacilitiesTravelFormValue[K]
  ) => void;
  onNext: () => void;
  onBack: () => void;
  onSave?: () => void;
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 flex flex-col h-full">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-gray-100">
        <div>
          <h2 className="text-[24px] font-bold font-serif text-gray-900 tracking-tight">
            Edit Facilities, Travel & Dynamic Details
          </h2>
          <p className="text-sm text-gray-500 mt-1">
            Update place-specific details for Smart Travel Assistant, Opening Hours, Contacts, Timeline, and Etiquette.
          </p>
        </div>
      </div>
