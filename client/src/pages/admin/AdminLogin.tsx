...
const AdminLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // error message is already captured in useAuth's error state
    }
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-black">
        ...
        <div className="absolute bottom-16 left-16 right-16 text-white z-10">
          ...
          <p className="text-gray-300 text-base font-['Inter'] leading-relaxed max-w-md">
            A Unified Platform For The Department Of Archaeology, Royal College Colombo & HEJ
            Ceylon To Catalogue, Protect And Share The Island's Living History.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 relative bg-[#F8F6F1]">
        ...
        <div className="w-full max-w-[28rem] bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-4 mt-20">
          ...
          <div className="flex items-center justify-center mb-8">
            ...
            <h2 className="mx-4 text-[#B98E3A] font-semibold tracking-[0.15em] text-xs uppercase">
              Admin Login
            </h2>
            <div className="h-[1px] w-12 bg-[#B98E3A]/40"></div>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            {/* Email Field */}
            <div>
              <label className="block text-gray-800 font-medium text-[15px] mb-2 font-['Inter']">
                Email Address
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-gray-800 font-medium text-[15px] font-['Inter']">
                  Password
                </label>
                <a
                  href="#"
                  className="text-xs text-[#D97757] hover:text-[#c46142] transition-colors font-medium"
                >
                  Forget Password?
                </a>
              </div>
            ...
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember"
                className="ml-2.5 text-xs font-semibold text-gray-800 cursor-pointer font-['Inter'] tracking-wide"
              >
                Keep Me signed in
              </label>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className={`w-full ${
                loading ? "bg-[#1c4437] opacity-70" : "bg-[#275949] hover:bg-[#1c4437]"
              } text-white font-medium text-[15px] py-3.5 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group shadow-[0_4px_14px_0_rgb(39,89,73,0.39)] mt-2`}
            >
          ...
          <div className="mt-2 ml-25 text-[13px] text-gray-800 font-['Inter'] font-semibold">
            ...
            <Link to="/" className="text-[#275949] hover:underline font-bold">
              Click Here
            </Link>
          </div>
        </div>
