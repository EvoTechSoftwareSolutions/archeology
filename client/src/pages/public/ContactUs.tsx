...
const ContactUs = () => {
  ...
  return (
    <div className="bg-[#F8F6F1] min-h-screen">
      ...
      >
        <p className="text-[#C89B3C] text-[0.8rem] font-bold tracking-[3px] uppercase mb-2">GET IN TOUCH</p>
      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-10 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16">
          ...
          {/* Form */}
          <div>
            <p className="text-[#C89B3C] text-[0.8rem] font-bold tracking-[3px] uppercase mb-2">SEND A MESSAGE</p>
            <h2 className="font-serif text-[2rem] font-bold text-[#1f2937] mb-8">We'd love to hear from you</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  <label className="block text-[#1f2937] font-bold text-sm mb-1.5">Full Name</label>
                  <input
                    required
                    type="text"
                ...
                <div>
                  <label className="block text-[#1f2937] font-bold text-sm mb-1.5">Email Address</label>
                  <input
                    required
                    type="email"
              ...
              <div>
                <label className="block text-[#1f2937] font-bold text-sm mb-1.5">Subject</label>
                <input
                  required
                  type="text"
              ...
              <div>
                <label className="block text-[#1f2937] font-bold text-sm mb-1.5">Message</label>
                <textarea
                  required
                  rows={6}
          ...
          <div className="space-y-6">
            <p className="text-[#C89B3C] text-[0.8rem] font-bold tracking-[3px] uppercase mb-2">CONTACT DETAILS</p>
            <h2 className="font-serif text-[1.8rem] font-bold text-[#1f2937] mb-6">Reach Us Directly</h2>
            ...
            {[
              ...
              >
                <div className="w-10 h-10 rounded-full bg-[#E8F3EE] flex items-center justify-center shrink-0 group-hover:bg-[#1C5F46] transition-colors">
                  <item.icon className="text-[#1C5F46] group-hover:text-white transition-colors" size={18} />
                </div>
                <div>
                  <p className="text-xs text-[#6b7280] uppercase tracking-wide font-bold mb-0.5">{item.label}</p>
                  <p className="text-[#1f2937] font-bold text-[0.95rem]">{item.value}</p>
                </div>
              </a>
            ))}
