...
export const districts: District[] = [
  {
    ...
    bbox: { x: 495.4, y: 241.9, width: 153.0, height: 195.6 },
    labelX: 566.7,
    labelY: 325.6,
    historicalPlaces: [
      {
        name: "Koneswaram Temple",
        image: "https://commons.wikimedia.org/wiki/Special:FilePath/Beautiful Koneswaram Temple.jpg?width=400",
        description:
          "Fort Frederick and the cliffside Koneswaram Temple crown a natural deep-water harbour.",
        anchorXPct: 0.466,
        anchorYPct: 0.428,
      },
    ],
  },
  {
    ...
    bbox: { x: 362.1, y: 133.1, width: 180.6, height: 120.9 },
    labelX: 452.5,
    labelY: 183.2,
    historicalPlaces: [
      {
        name: "Nayaru Lagoon",
        image: "https://picsum.photos/seed/nayaru-lagoon/400/300",
        description:
          "A remote lagoon coastline where heritage centers on fishing traditions and untouched landscapes.",
        anchorXPct: 0.501,
        anchorYPct: 0.414,
      },
    ],
    ...
    historicalPlaces: [
      {
        ...
        description:
          "Home to the riverside Kelaniya Temple, one of the sixteen most sacred Buddhist sites on the island.",
        anchorXPct: 0.496,
        anchorYPct: 0.505,
      },
    ],
  },
  {
    ...
    bbox: { x: 286.8, y: 710.0, width: 86.1, height: 61.7 },
    labelX: 310.9,
    labelY: 740.3,
    historicalPlaces: [
      {
        name: "Colombo National Museum",
        image: "https://commons.wikimedia.org/wiki/Special:FilePath/Colombo National Museum Sri Lanka.JPG?width=400",
        description:
  ...
  },
  {
    ...
    bbox: { x: 297.1, y: 746.6, width: 112.7, height: 114.9 },
    labelX: 350.0,
    labelY: 808.3,
    historicalPlaces: [
      {
        name: "Kalutara Bodhiya",
        image: "https://picsum.photos/seed/kalutara-bodhiya/400/300",
        description:
          "A hollow-domed stupa built around a sacred Bodhi tree on the Kalu Ganga estuary.",
        anchorXPct: 0.469,
        anchorYPct: 0.537,
      },
    ],
  ...
  },
  {
    ...
    bbox: { x: 462.8, y: 802.6, width: 253.7, height: 139.9 },
    labelX: 578.3,
    labelY: 874.0,
    historicalPlaces: [
      {
        name: "Kataragama Sacred City",
        image: "https://picsum.photos/seed/kataragama/400/300",
        description:
          "The forested shrine city of Kataragama, sacred to Buddhists, Hindus, and Vedda communities alike.",
        anchorXPct: 0.455,
        anchorYPct: 0.51,
      },
    ],
    ...
    historicalPlaces: [
      {
        ...
        description:
          "A lagoon-bound Dutch fort town, near the bridge where the region's 'singing fish' are said to be heard.",
        anchorXPct: 0.383,
        anchorYPct: 0.538,
      },
    ],
